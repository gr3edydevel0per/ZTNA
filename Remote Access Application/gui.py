...
class BrowserWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("assets/images/owl.png"))  # Ensure this image exists
        ...
        self.tray_icon = QSystemTrayIcon(QIcon("assets/images/owlhiddenActive.png"), self)  # Ensure this image exists
